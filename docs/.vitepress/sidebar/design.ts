export default [
  ...
  },
  {
    ...
    items: [
      ...
      { text: '6.9 开发者速成文档', link: '/design/0x06_教程与案例/0x09_开发者速成文档' }
    ]
  },
  {
    text: '7. 字体和图片素材处理',
    items: [
      { text: '7.1 关于字体的一些知识', link: '/design/0x06_字体和图片素材处理/0x00_关于字体的一些知识' },
      { text: '7.2 字体文件的处理流程', link: '/design/0x06_字体和图片素材处理/0x00_字体文件的处理流程' },
      { text: '7.3 将现有 ttf 文件导出为 svg', link: '/design/0x06_字体和图片素材处理/0x00_将现有ttf文件导出为svg' },
      { text: '7.4 图标编辑和资源', link: '/design/0x06_字体和图片素材处理/0x02_图标编辑和资源' },
      { text: '7.5 天气图标处理', link: '/design/0x06_字体和图片素材处理/0x03_天气图标处理' },
      { text: '7.6 图标合并', link: '/design/0x06_字体和图片素材处理/0x04_图标合并' },
      { text: '7.7 method-drawText 方法说明', link: '/design/0x06_字体和图片素材处理/method-drawText方法说明' }
    ]
  }
]
